...
impl Default for Party {
    fn default() -> Self {
        ...
        // Self { at_restaurant: Default::default(), num_people: Default::default(), cake: Cake::MapleBacon }
    }
}
...
impl PartialEq for Party {
    fn eq(&self, other: &Self) -> bool {
        ...
        // self.at_restaurant == other.at_restaurant && self.num_people == other.num_people && self.cake == other.cake
    }
}
